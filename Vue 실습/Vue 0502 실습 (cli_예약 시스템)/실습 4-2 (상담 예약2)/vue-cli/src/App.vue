<template>
  <div id="app">
    ...
    <div style="width:830px; height:450px; display:inline-block;">
      <div class="box divleft" style="height:inherit; padding:20px;">
        <h2>예약 페이지</h2>
        <h3>선생님 선택</h3>
        <div>
          ...
          class="selected1"
          @click="btnclick2"
          :class="{'selected2':isSelected2(teacher)}" style="border: 1px solid; border-color:#0F4c81;">{{teacher}}</button>
        </div>
        <hr>
        <h3>시간 선택</h3>
        <div>
      ...
      <div class="box divright" style="height:inherit; padding:20px;">
        <h2>상담 신청 현황</h2>
        <h3>상담 선생님</h3>
        <h4>성함 : 
          {{selected2[0]}}
        ...
        <hr>
        <img alt="ssafy_logo" src="./assets/ssafy-logo.png" style="padding: 15px;">
      </div>
    </div>
  </div>
</template>
